...
const CallsTable: React.FC<CallsTableProps> = ({ records, onRowClick }) => {
    // ... (helper functions remain same)

    // This part wraps the table logic, but we need to target the specific props interface update and the row render.
    // Since replace_file_content works on chunks, I'll update the interface first.
                    ...
                    <tbody className="divide-y divide-[var(--border)]">
                        {records.map((record) => (
                            <tr
                                ...
                                className="hover:bg-[var(--row-hover)] transition-all duration-150 group cursor-pointer"
                            >
